...
app.post('/users', async function (req, res) {
    ...
    // let message = await query.query("mychannel", "fabcar", args, "getPersonById", username, orgName);
    ...
    let response = await helper.getRegisteredUser(username, orgName, usertype,password, true);
    logger.debug(response)
    logger.debug('-- returned from registering the username %s for organization %s', username, orgName);
    if (response && typeof response !== 'string') {
        logger.debug('Successfully registered the username %s for organization %s', username, orgName);
        response.token = token;
        let message = await invoke.invokeTransaction("mychannel", "fabcar", "addPerson", args, username, orgName, '');
        res.json(response);
    } else {
...
app.post('/update-password', async function (req, res) {
    ...
    let response = await helper.updatePassword(username, orgName, usertype,password,newpassword);
    logger.debug(response)
    logger.debug('-- returned from registering the username %s for organization %s', username, orgName);
    if (response && typeof response !== 'string') {
        logger.debug('Successfully registered the username %s for organization %s', username, orgName);
...
app.post('/addPaper', async function (req, res) {
    try {
        logger.debug('==================== INVOKE ON CHAINCODE ==================');
        var peers = req.body.peers;
        var fcn = req.body.fcn;
        ...
        let message = await invoke.invokeTransaction("mychannel", "fabcar", fcn, args, req.username, req.orgname, transient);
        console.log(`message result is : ${message}`)
...
app.post('/updatePaper', async function (req, res) {
    try {
        logger.debug('==================== INVOKE ON CHAINCODE ==================');
        var peers = req.body.peers;
        var fcn = req.body.fcn;
...
app.post('/submitPaper', async function (req, res) {
    try {
        logger.debug('==================== INVOKE ON CHAINCODE ==================');
        var peers = req.body.peers;
        var fcn = req.body.fcn;
...
app.get('/get/:channelName/personbyattribute/:chaincodeName', async function (req, res) {
    try {
